  ...
  fr: {
    ...
    packs: {
      ...
      discovery: {
        ...
        description: "10 sticks individuels : 6 Daily Matcha Latte + 3 Ceremonial + 1 Grand Cru.",
        contains: "Contient 10 sticks de 1g",
      },
      duoCeremonial: {
        title: "Pack Duo Ceremonial",
        description: "4 sticks Ceremonial.",
        contains: "Contient 4 sticks de 1g",
      },
      duoGrandCru: {
        title: "Pack Duo Grand Cru",
        description: "2 sticks Grand Cru.",
  ...
  en: {
    ...
    packs: {
      ...
      discovery: {
        ...
        description: "10 individual sticks: 6 Daily Matcha Latte + 3 Ceremonial + 1 Grand Cru.",
        contains: "Contains 10 x 1g sticks",
      },
      duoCeremonial: {
        title: "Duo Ceremonial Pack",
        description: "4 Ceremonial sticks.",
        contains: "Contains 4 x 1g sticks",
      },
      duoGrandCru: {
        title: "Duo Grand Cru Pack",
        description: "2 Grand Cru sticks.",
